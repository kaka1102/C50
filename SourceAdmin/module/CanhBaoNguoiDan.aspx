<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="CanhBaoNguoiDan.aspx.cs" Inherits="SourceAdmin_module_CanhBaoNguoiDan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        var page = 'danhsachcanhbaonguoidan';
    </script>
</asp:Content>
