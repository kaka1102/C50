<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="QuanLyThuMucAnh.aspx.cs" Inherits="SourceAdmin_module_QuanLyThuMucAnh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content" id="frmnoidung">
                                <div class="tab-pane active box-body" id="danhsachanhhienthi">
                                    (Bấm F2 để đổi tên , Delete để xóa)
                                    <div class="nav-tabs-custom">
                                ...
                                <div class="tab-pane " id="uploadvaothumuc"  style="    min-height: 400px;padding-top:20px">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <input type="file" id="anhdaidien" accept="image/*" title="Chọn ảnh từ máy tính (nhỏ hơn 10 mb)"/>
    ...
    <div>
        <ul class="vakata-context jstree-contextmenu jstree-default-contextmenu popup_msg" id="popuup_div">
            <li><a id="deleteimg"><i class="fa fa-trash-o"></i><span class="vakata-contextmenu-sep">&nbsp;</span>Xóa ảnh</a></li>
            <li><a id="renameimg"><i class="fa fa-edit"></i><span class="vakata-contextmenu-sep">&nbsp;</span>Đổi tên</a></li>
        </ul>
    </div>
    <script type="text/javascript">
        var page = 'quanlythumucanh';
    </script>
</asp:Content>
