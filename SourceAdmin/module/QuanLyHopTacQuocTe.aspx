<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="QuanLyHopTacQuocTe.aspx.cs" Inherits="SourceAdmin_module_QuanLyHopTacQuocTe" %>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12" id="groupChosefileavbv">
                                                <div class="help-block">
                                                    <button id="chosefileavbv" class="buttonBanner" type="button" value="Chọn">Chọn file</button>&nbsp&nbsp Click để chọn file cần sử dụng
                                                </div>
                                            </div>
