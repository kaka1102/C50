<%@ Page Title=""ValidateRequest="false" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ThuVienAnhClient.aspx.cs" Inherits="SourceAdmin_module_ThuVienAnhClient" %>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs" id="ulmenu">
                        <li class="active" id="lidanhsach"><a href="#danhsachalbumanh" data-toggle="tab" aria-expanded="false"><i class="fa  fa-list-ul iconTab"></i>Danh sách album</a></li>
                        <li class="" id="liaddnew"><a href="#themmoialbumanh" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus iconTab"></i>Thêm mới</a></li>
                        <li class="" id="liadetails" style="display: none"><a href="#themmoialbumanh" data-toggle="tab" aria-expanded="false"><i class="fa fa-edit iconTab"></i>Chi tiết album</a></li>
                    </ul>
                        ...
                        <div class="tab-pane box-body" id="themmoialbumanh">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group" style="display: none" id="frmShowIMG">
                                    <label class="col-sm-2 control-label">Danh sách ảnh</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div id="showImg">
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10" id="groupChosefile">
                                        <div class="help-block">
                                            <button id="chosefile" class="button123" type="button" value="Chọn">Click chọn nhiều ảnh</button>&nbsp&nbsp Click chọn file cần sử dụng
                                        </div>
                                    </div>
                                    <div class="col-sm-10 pull-right">
                                        <div class="row"  id="groupFile">
