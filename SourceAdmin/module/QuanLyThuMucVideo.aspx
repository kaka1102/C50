<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="QuanLyThuMucVideo.aspx.cs" Inherits="SourceAdmin_module_QuanLyThuMucVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content" id="frmnoidung">
                                ...
                                <div class="tab-pane " id="uploadvaothumuc" style="padding-top:20px">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <input type="file" id="anhdaidien" accept="audio/wav,audio/mpeg,video/avi,video/x-flv,video/*" title="Chọn video từ máy tính (Kích thước file < 50 Mb)" />
    ...
    <div>
        <ul class="vakata-context jstree-contextmenu jstree-default-contextmenu popup_msg" id="popuup_div">
            <li><a id="deleteimg"><i class="fa fa-trash-o"></i><span class="vakata-contextmenu-sep">&nbsp;</span>Xóa video</a></li>
            <li><a id="renameimg"><i class="fa fa-edit"></i><span class="vakata-contextmenu-sep">&nbsp;</span>Đổi tên</a></li>
        </ul>
    </div>

    <script type="text/javascript">
        var page = 'quanlythumucvideo';
    </script>
</asp:Content>
