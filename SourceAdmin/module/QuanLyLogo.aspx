<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="QuanLyLogo.aspx.cs" Inherits="SourceAdmin_module_QuanLyLogo" %>
                                                 ...
                                                 <div class="col-sm-12" style="padding-top: 20px">
                                                    <div class="row">
                                                        <div class="col-sm-9" id="groupChosefile">
                                                            <div class="">
                                                                <button id="buttonLogo" class="buttonLogo" type="button" value="Chọn" title="Kích thước đề nghị :Logo trên 515 x 125px ,Logo dưới 145 x 135px">Chọn ảnh</button>
                                                                Click chọn logo cần sử dụng<span class="required-admin">*</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="box box-info">
                                                                <div class="box-header">
                                                                    Thông tin logo (có thể nhập hoặc để trống)
                                                                ...
                                                                <div class="box-body pad" id="chonMenu">
                                                                    <form class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <label for="inputName" class="col-sm-4 control-label">Tên logo</label>
                                                                            <div class="col-sm-8">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" id="vitri">
                                                                                    <option value="Logo trên">Logo trên</option>
                                                                                    <option value="Logo dưới">Logo dưới</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="inputName" class="col-sm-4 control-label">Link logo</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" id="linkbanner" placeholder="Nhập link khi click vào logo sẽ chuyển đến">
