...
public partial class SourceClient_TinhHuongKhanCap : System.Web.UI.Page
{
    DataC50Entities tinhhuongkhancap = new DataC50Entities();
    ...
    public void DANHSACHTONGDAI()
    {
        try
        {
            ...
            var danhsach = tinhhuongkhancap.SP_DANHSACHTONGDAI(2, noidung, currPage, 8, totalCount).ToList();
            if (danhsach.Count > 0)
            {
