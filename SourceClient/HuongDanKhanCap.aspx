<%@ Page ValidateRequest="false" Title="" EnableViewState="false" Language="C#" MasterPageFile="~/MT_Client.master" AutoEventWireup="true" CodeFile="HuongDanKhanCap.aspx.cs" Inherits="SourceClient_HuongDanKhanCap" %>
    ...
    <section>
                    ...
                    <div class="row">
                        <div class="content-left-hd col-sm-8 ">
                            ...
                            <div class="title-catalog clearfix">
                                <h2><a id="titleTHKC">DANH SÁCH TÌNH HUỐNG</a></h2>
                            </div>
                                        ...
                                        <ItemTemplate>
                                            <div class="title-catalog-content clearfix">
                                                <div class="title-content-hd">
                                                    <b><i class="fa fa-plus-circle"></i><%# Eval("tieude") %></b>
                                                </div>
                                                <p>
                                                    <%# Eval("tinhhuong") %>
                                                </p>
                                                <a href="<%# Eval("linktinhhuong")+"-"+Eval("id_huongdan")+".html" %>" class="showmes"><i class="fa fa-quote-left"></i>xem câu trả lời</a>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#titleTHKC').attr('href', window.location.origin + "/tinh-huong-khan-cap/huong-dan-xu-ly-tinh-huong");
