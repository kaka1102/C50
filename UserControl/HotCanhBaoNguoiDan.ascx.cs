...
public partial class UserControl_HotCanhBaoNguoiDan : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            var tentrang = entity.Menu_Client.Where(m => m.duongdan == "/canh-bao-nguoi-dan" && m.trangthai == 1).ToList().Select(m => new
            {
            ...
            if (tentrang != null)
            {
                ...
                {
                    RepeaterCanhBaoNguoiDan.DataSource = danhsachSlider;
                    RepeaterCanhBaoNguoiDan.DataBind();
                }
                else
                {
                    RepeaterCanhBaoNguoiDan.Visible = false;
                }
            }
            else
            {
    ...
    public List<Contructor.baiviet> GetAllGuongdienhinh()
    {
        ...
        try
        {
            ...
            var dscha = entity.tbl_Vitribv.Where(zz => zz.id_danhmuc == 115 && zz.trangthaibaiviet == 1).ToList().Select(zz => new
            {
                zz.id_baiviet,
                zz.id_danhmuc,
                zz.id_vitribv,
