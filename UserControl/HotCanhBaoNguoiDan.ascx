<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HotCanhBaoNguoiDan.ascx.cs" Inherits="UserControl_HotCanhBaoNguoiDan" %>
...
<div class="catalog-content">
    <div class="catalog-border">
        <div class="catalog-bg">
            <div class="row">
                <asp:Repeater ID="RepeaterCanhBaoNguoiDan" runat="server">
                    <ItemTemplate>
